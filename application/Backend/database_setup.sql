...
-- CREATE DATABASE
-- =========================
CREATE DATABASE IF NOT EXISTS csc648_db;
USE csc648_db;
...
(2, 'Math 226 Calculus Notes', 'Detailed handwritten notes for calculus', 20.00, 'Textbooks', 'MATH 226', 'Cesar Chavez Center', '2026-01-02 08:12:49', 'Fair', 'active'),
...
-- VERIFY
-- =========================
SELECT listing_id, title, price, category_name, item_condition, status
FROM Listing
ORDER BY listing_id;